...
function SearchProductForm() {
    ...
    const searchForm = (e:any) =>{
        if(keywordFilterRef == null){
            ...
            console.log(productsStore?.filter((product) => product?.sku?.includes(keywordFilterRef.current.value) || product?.name?.includes(keywordFilterRef.current.value) || product?.description?.includes(keywordFilterRef.current.value)))
            console.log(keywordFilterRef.current.value)
        }
    }
