...
function SearchProductForm() {
    ...
    const searchForm = (e:any) =>{
        dispatch(productsActions.products({
            isSearching:true,
            data:productsStore.filter((product) => product.sku.includes(keywordFilterRef) || product.name.includes(keywordFilterRef) || product.description.includes(keywordFilterRef))
        }))
    }
