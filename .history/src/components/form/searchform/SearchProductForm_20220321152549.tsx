...
function SearchProductForm() {
    ...
    const searchForm = (e:any) =>{
        if(keywordFilterRef == null){
            ...
            dispatch(productsActions.SearchProductForm({
                isSearching:true,
                data:productsStore?.filter((product) => product?.sku?.includes(keywordFilterRef.toString()) || product?.name?.includes(keywordFilterRef.toString()) || product?.description?.includes(keywordFilterRef.toString()))
            }))
            console.log(productsStore?.filter((product) => product?.sku?.includes(keywordFilterRef.toString()) || product?.name?.includes(keywordFilterRef.toString()) || product?.description?.includes(keywordFilterRef.toString())))
        }
    }
