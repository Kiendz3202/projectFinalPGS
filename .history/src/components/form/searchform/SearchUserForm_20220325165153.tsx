        ...
        <div  className='text-white '>
            <div className='flex mb-[10px]'>
                <div className='flex justify-center w-[175px] leading-[38px]'>
                 ...
                 <select onChange={categoryFilterHandle} defaultValue='anycategory' className='max-w-[300px] h-[38px] py-[7px] px-[16px] outline-none bg-[#252547] rounded-lg'>
                    <option value='anycategory'>Any category</option>
                    {categories.map((category,index) => (<option value={category.name} key={category.id}>{category.name}</option>))}
                    {/* <option value="volvo">Volvo</option> */}
                </select>
            ...
            <div className='flex'>
                <div className='flex justify-center w-[175px] leading-[38px]'>
                 ...
                 <select onChange={categoryFilterHandle} defaultValue='anycategory' className='max-w-[300px] h-[38px] py-[7px] px-[16px] outline-none bg-[#252547] rounded-sm'>
                    <option value='anycategory'>Any category</option>
                    {categories.map((category,index) => (<option value={category.name} key={category.id}>{category.name}</option>))}
                    {/* <option value="volvo">Volvo</option> */}
                </select>
