...
function SearchProductForm(){
  ...
  return (
    ...
    <div className='bg-[#323259] w-full px-[20px] pt-[20px]'>
        ...
        <div  className={`text-white flex relative transition-maxHeight duration-700 ease-in-out overflow-hidden`} ref={contentSpace} style={{maxHeight:`${height}`}}>
            <div className='flex mb-[10px]'>
                <div className='flex justify-center w-[175px] leading-[38px]'>
                    <label htmlFor='country'>Country</label>
                </div>
                 <select onChange={categoryFilterHandle} defaultValue='anycategory' className='w-[300px] h-[38px] py-[7px] px-[16px] outline-none bg-[#252547] rounded-lg'>
                    <option value='anycategory'>Any category</option>
                    {categories.map((category,index) => (<option value={category.name} key={category.id}>{category.name}</option>))}
                    {/* <option value="volvo">Volvo</option> */}
                </select>
            ...
            <div className='flex mb-[10px]'>
                ...
                <input type='text'  className='w-[300px] h-[38px] py-[7px] px-[16px] outline-none bg-[#252547] rounded-lg' />
            </div>
            <div className='flex mb-[10px]'>
                <div className='flex justify-center w-[175px] leading-[38px]'>
