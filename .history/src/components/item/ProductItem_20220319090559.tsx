...
function ProductItem(props: Props) {
  ...
  return (
    <div className=' grid grid-cols-12 gap-3 text-white  border-black border-t'>
            ...
            <div onClick={() => navigate(`/productlist/detail-product/${id}`)} className=' col-span-3 my-auto text-[#007EFF] cursor-pointer hover:border-b border-[#007EFF] truncate'>{name}</div>
