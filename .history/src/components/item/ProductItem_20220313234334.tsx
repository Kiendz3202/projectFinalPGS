...
function ProductItem() {
  return (
    <div className=' grid grid-cols-12 gap-3 text-white  border-black border-t'>
            ...
            <div className=' col-span-3 my-auto text-[#007EFF] cursor-pointer hover:border-b border-[#007EFF] whitespace-nowrap text-ellipsis'>3x2m Effect Image Solid color Backgrounds Black screen </div>
            ...
            <div className=' col-span-1 my-auto text-[#007EFF] cursor-pointer'>Administrator</div>
