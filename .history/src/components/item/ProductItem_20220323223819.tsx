...
function ProductItem(props: Props) {
  ...
  const [selectedCheckbox,setSelectedCheckbox] = useState(isSelectedAll)
  ...
  return (
    <div className=' grid grid-cols-12 gap-3 text-white  border-black border-t'>
            <div className='flex items-center col-span-1 my-[16px]'>
                <input onChange={checkboxHandle} checked={selectedCheckbox} type='checkbox' className='mr-[10px] leading-[24px] ml-[20px]' />
