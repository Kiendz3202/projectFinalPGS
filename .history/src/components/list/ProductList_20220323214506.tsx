  ...
  return (
    <div className='bg-[#323259]'>
        <div className='grid grid-cols-12 gap-3 text-white'>
            ...
            <div className='flex justify-end my-auto col-span-1 rounded-sm cursor-pointer'><span className='ml-[10px] bg-[#b18aff]'><Delete className=' hover:text-black' /></span></div>
        </div>
