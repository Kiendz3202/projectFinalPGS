...
function ProductList() {
  ...
  const checkboxHandle = (e:any) =>{
    ...
    if(isSelectedAll){
      data = products.filter((product:fetchResponse) => {
        pagination.currentData.forEach(element => {
  ...
  return (
    <div className='bg-[#323259]'>
        <div className='grid grid-cols-12 gap-3 text-white'>
            ...
            <div className='flex justify-end my-auto col-span-1'><span className='mr-[12px] rounded-sm cursor-pointer bg-[#b18aff]'><Delete className=' hover:text-black' /></span></div>
        </div>
