    ...
    return (
        ...
        onSubmit();
                ...
                <div className=' justify-center mb-[5px] '>
                    <input onChange={(e) => setFormValue({...formValue,email:e.target.value})} value={email} type="text" className='w-full p-[10px] border border-gray-600 outline-blue-300' placeholder='Email' />
                    {isValidated.email ?? <p>{isValidated.email}</p>}
                </div>
                <div className=' justify-center mb-[10px] '>
                    <input onChange={(e) => setFormValue({...formValue,password:e.target.value})} value={password} type="password" className='w-full p-[10px] border border-gray-600 outline-blue-300' placeholder='Password' />
