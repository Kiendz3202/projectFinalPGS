...
interface Props{
    onLogin(value:ILoginValidation,isValidated:ILoginValidation):void;
    loading:boolean;
    errorMessage:string
}
...
function Login(props:Props) {
    ...
    const onSubmit = (e: React.FormEvent<HTMLElement>) =>{
        ...
        console.log(isValidated)
            onLogin(formValue,isValidated)

    }
    return (
        <div className=' max-w-[410px] w-full m-auto border-2 mt-[200px]'>
            <form onSubmit={onSubmit} className='flex flex-col w-[380px] p-[15px] bg-[#f3f3f3] drop-shadow-md'>
