    ...
    return (
        ...
        onSubmit();
                ...
                <div className=' justify-center mb-[5px] '>
                    <input onChange={(e) => setFormValue({email:e.target.value,...formValue})} value={email} type="text" className='w-full p-[10px] border border-gray-600 outline-blue-300' placeholder='Email' />
                    {isValidated.email ?? <p>{isValidated.email}</p>}
                </div>
                <div className=' justify-center mb-[10px] '>
                    <input onChange={(e) => setFormValue({password:e.target.value,...formValue})} value={password} type="password" className='w-full p-[10px] border border-gray-600 outline-blue-300' placeholder='Password' />
