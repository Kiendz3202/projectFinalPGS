...
function Login(props:Props) {
    ...
    // const onSubmit = React.useCallback((e: React.FormEvent<HTMLElement>) =>{
        // e.preventDefault();
        ...
        // console.log(isValidated)
            // onLogin(formValue))
    // }
    const valid = (value:ILoginValidation) =>{
    ...
    const onSubmit = React.useCallback(() => {
        setIsValidated(!valid(ValidateLoginForm(formValue)));
        console.log(ValidateLoginForm(formValue))
        console.log(valid(ValidateLoginForm(formValue)))
        if (!valid(ValidateLoginForm(formValue))) {
            return;
          }
