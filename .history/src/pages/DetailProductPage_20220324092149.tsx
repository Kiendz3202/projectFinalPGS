...
function DetailProductPage() {
  ...
  let date = new Date(product?.arrivalDate * 1000)
      ...
      <div>
        ...
        <div>
            ...
            <div className='flex mb-[26px]'>
              ...
              <input id='date' type='date' onChange={dateHandle}  value={date} className='bg-[#252547] h-[38px] w-[380px] pl-[15px] pr-[40px] truncate' />
            </div>
            <div className='flex mb-[26px]'>
              <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
