...
function DetailProductPage() {
  ...
  console.log(date.toLocaleString('en-GB').split(' ')[0].split('/').reverse().join('-'))
      ...
      <div>
        ...
        <div>
            ...
            <div className='flex mb-[26px]'>
              ...
              <input id='date' type='date' onChange={dateHandle} value={date.toISOString().slice(0,10).replace(/-/g,"")}  className='bg-[#252547] h-[38px] w-[380px] pl-[15px] pr-[40px] truncate' />
            </div>
            <div className='flex mb-[26px]'>
              <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
