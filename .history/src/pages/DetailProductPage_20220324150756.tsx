...
function DetailProductPage() {
  ...
  const changeHandle = () =>{
    let dataChanged: fetchResponse[] = productsData
    ...
    dataChanged = productsData.map((obj) => obj.id === productId ? {...obj,vendor:product?.vendor,name:product?.name,sku:product?.sku,category:product?.category,description:product?.description,price:product?.price,arrivalDate:product?.arrivalDate,amount:product?.amount} : obj )
    ...
    console.log(productsData.map((obj) => obj.id === productId ? {...obj,vendor:product?.vendor,name:product?.name,sku:product?.sku,category:product?.category,description:product?.description,price:product?.price,arrivalDate:product?.arrivalDate,amount:product?.amount} : obj ))
    // dispatch(productsActions.SearchProductForm({
    //   isSearching:false,
    //   data:dataChanged
    // }))
