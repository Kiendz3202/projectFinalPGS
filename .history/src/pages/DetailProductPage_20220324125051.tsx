...
function DetailProductPage() {
  ...
  const changeHandle = () =>{
    ...
    dataChanged[productChangedIndex].vendor = product?.vendor 
    dataChanged[productChangedIndex].name = product?.name 
    dataChanged[productChangedIndex].sku = product?.sku 
    dataChanged[productChangedIndex].category = product?.category 
    dataChanged[productChangedIndex].description = product?.description 
    dataChanged[productChangedIndex].price = product?.price
    dataChanged[productChangedIndex].arrivalDate = product?.arrivalDate
    dataChanged[productChangedIndex].amount = product?.amount
