  ...
  return (
    <div className='bg-[#1b1b38] w-full h-screen ml-[256px] mt-[76px] p-[36px] text-white'>
      ...
      <div className='my-[32px]'>
        <div>
          <div className='flex'>
            <div className='flex justify-end w-[175px] leading-[38px] mr-[10px]'>
              <label htmlFor='vendor'>Vendor <span className='text-[#d13143]'>*</span></label>
            </div>  
            <input id='vendor' type='text' placeholder='Type Vendor name to select' className='bg-[#252547] h-[38px]' />
          </div>
        </div>
      </div>
    </div>
