    ...
    <div className='bg-[#1b1b38] w-full h-screen ml-[256px] mt-[76px] p-[36px] text-white'>
      ...
      <div className='my-[32px]'>
        <div>
          ...
          <div className='flex mb-[26px]'>
            <div className='flex justify-end w-[175px] leading-[38px] mr-[20px]'>
              <label htmlFor='vendor'>Product Title <span className='text-[#d13143]'>*</span></label>
            </div>  
            <input id='vendor' type='text' onChange={titleHandle} value={productTitle} className='bg-[#252547] h-[38px] w-[380px] pl-[15px] pr-[40px] truncate' />
          </div>
        </div>
