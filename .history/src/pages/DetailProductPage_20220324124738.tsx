...
function DetailProductPage() {
  ...
  const changeHandle = () =>{
    ...
    //   return prev;
    // })
    Object.assign(dataChanged[productChangedIndex],{name:product?.name,sku:product?.sku,category:product?.category,description:product?.description,price:product?.price,arrivalDate:product?.arrivalDate,amount:product?.amount})
