...
function DetailProductPage() {
  ...
  const changeHandle = () =>{
    ...
    dispatch(productsActions.products({
      data:productsData.map((obj) => obj.id === productId ? {...obj,vendor:product?.vendor,name:product?.name,sku:product?.sku,category:product?.category,description:product?.description,price:product?.price,arrivalDate:product?.arrivalDate,amount:product?.amount} : obj )
    }))
